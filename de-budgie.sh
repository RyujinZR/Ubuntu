...
gnome-flashback &" > /usr/local/bin/vncstart
   ...
   echo ""
#Browser Fix
wget https://raw.githubusercontent.com/RyujinZR/Ubuntu/main/Patch/browserfix.sh ; chmod +x browserfix.sh ; ./browserfix.sh
wget https://raw.githubusercontent.com/RyujinZR/Ubuntu/main/libreofficefix.sh ; chmod +x libreofficefix.sh ; ./libreofficefix.sh
   clear
   echo ""
   echo "In Termux"
